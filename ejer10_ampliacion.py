def iguales(lista1, lista2, lista3):
    ...
    if len(lista1) != len(lista2) or len(lista2) != len(lista3) and len(lista1) != len(lista3):
        return False

    # Recorrer listas y comparar letra a letra, ignorando mayúsculas
    for i in range(len(lista1)):
        if lista1[i].lower() != lista2[i].lower() or lista2[i].lower() != lista3[i].lower() and lista1[i].lower != lista3[i].lower:
            return False
